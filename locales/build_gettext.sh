...
cd ${BASE_PATH}
${XGETTEXT_BIN} --no-wrap -F -k__gettext -k__ -k__n:1,2 -k__x:1c,2 -k__xn:1c,2,3 -k__esc -k__esc_n:1,2 -k__esc_x:1c,2 -k__esc_xn:1c,2,3 -k__date -o locales/po/cacti.pot `find . -maxdepth 2 -name \*.php`
...
for file in `ls -1 locales/po/*.po`;do
	...
	msgmerge --no-wrap --backup off --update $file locales/po/cacti.pot
done
